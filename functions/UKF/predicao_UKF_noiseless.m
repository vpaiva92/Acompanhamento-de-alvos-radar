function [estado_predito, sigma_predito] = predicao_UKF_noiseless(estado_corrigido, sigma_corrigido, T, param_filtro)
    ...
    for i = 1:length(sigma_pontos)
        sigma_predito = modelo_alvo_noiseless(sigma_pontos(:,i),T);
