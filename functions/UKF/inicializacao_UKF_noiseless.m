function [estado_predito, sigma_predito] = inicializacao_UKF_noiseless(T, medicao, var_medicao, param_filtro)  
    ...
    sigma_corrigido = [var_x    var_x/T                               0     	covar_xy	0                                   0;
                       var_x/T  2*alfa*(((4-pi)/pi)+(2*var_x/T^2))	0   	0           0                                   0;
                       0        0                                 	10    	0           0                                   0;
                       covar_xy 0                                 	0   	var_y       var_y/T                         	0;
                       0        0                                     0       var_y/T     2*alfa*(((4-pi)/pi)+(2*var_y/T^2)) 	0;
                       0        0                                     0       0           0                                   2*alfa*((4-pi)/pi)];
    ...
    % PREDIÇÃO
    [estado_predito, sigma_predito] = predicao_UKF_noiseless(estado_corrigido, sigma_corrigido, T, param_filtro);
